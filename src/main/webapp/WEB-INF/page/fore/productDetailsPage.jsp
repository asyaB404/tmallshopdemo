...
<head>
    ...
    <title>${requestScope.product.product_name}-tmall.comBB</title>
</head>
<body>
<nav>
        ...
        <div class="shopSearchHeader">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="shopSearchInput">
                    <input type="text" class="searchInput" name="product_name" placeholder="搜索 BB 商品/品牌/店铺"
                           maxlength="50">
                    <input type="submit" value="搜BB" class="searchTmall">
                </div>
...
<div class="loginDiv">
    ...
    <div class="qrcodeLogin">
        ...
        <div class="qrcodeFooter">
            ...
            <p>打开 <a href="https://www.tmall.com/wow/portal/act/app-download">手机BB</a> | <a
...
<div class="context">
    ...
    <div class="context_info">
        ...
        <ul class="context_other_panel">
            ...
            <li class="tmall_points">送BB积分<span><fmt:formatNumber type="number"
