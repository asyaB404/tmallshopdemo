...
<nav>
        ...
        <div class="mallSearch">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="mallSearch-input">
                    <input class="header_search_input" type="text" name="product_name" placeholder="搜索 BB 商品/品牌/店铺"
                           maxlength="50">
    ...
    <div class="home_nav">
        ...
        <a href="http://vip.tmall.com/" target="_blank">BB会员</a>
